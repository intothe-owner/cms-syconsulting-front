    ...
    <div className="flex h-screen w-screen overflow-hidden bg-slate-50 font-sans text-slate-800">
      ...
      <aside className="w-64 bg-slate-900 flex flex-col h-full flex-shrink-0 shadow-2xl z-20">
        ...
        <nav className="flex-1 px-4 py-6 space-y-1 overflow-y-auto">
          ...
          <Link href="/admin/funds" className="flex items-center gap-3 px-3 py-3 rounded-xl text-slate-300 hover:bg-indigo-600 hover:text-white transition-all">
            <Briefcase size={18} />
            <span className="font-medium text-sm">사업지원금 관리</span>
          </Link>
